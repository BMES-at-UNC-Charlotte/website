 ...
 * Showcase of design system and components used across the site.
...
export default function DevPage() {
  ...
  /**
   * Function for handling the submission of the tRPC example form.
  ...
  async function handleSubmit(event: SubmitEvent<HTMLFormElement>) {
    ...
    setIsSending(true);
    try {
      // usually you would want to use the useQuery hook which handles
      // edge cases properly; this is just for simplicity
  ...
  return (
    <Container contentClassName="space-y-12">
      ...
      {/* Docs links + live tRPC request/response demo */}
      <section className="space-y-4">
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <Card>
            ...
            <CardContent>
              {/* nativeButton={false} + render -> styles a Link as a Button */}
              <Button
                variant="outline"
                nativeButton={false}
                render={
          ...
          <CardHeader>
            <div className="flex flex-row items-end justify-between">
              <div>
                ...
                <CardDescription>
                  {greeting ??
                    "Send a message to the tRPC hello endpoint, and it will show here."}
                </CardDescription>
              </div>
              <form
                ref={messageFormRef}
              ...
              >
                <InputGroup className="h-10">
                  <InputGroupInput
                    ...
                    placeholder="Send an API message..."
                    required
                    value={message}
                  />
      ...
      {/* Brand color tokens (bg-primary/secondary/etc. map to theme vars) */}
      <section className="space-y-4">
        <div className="space-y-1">
      ...
      {/* Surface/neutral colors section */}
      <section className="space-y-4">
        <div className="space-y-1">
      ...
      {/* Button variants, sizes, and states section */}
      <section className="space-y-4">
        <div className="space-y-1">
        ...
        <Card>
          ...
          <CardContent className="space-y-4">
            <div className="space-y-2">
              ...
              <Input id="email" type="email" placeholder="you@charlotte.edu" />
            </div>
            <div className="space-y-2">
